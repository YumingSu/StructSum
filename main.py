...
if __name__ == '__main__':
    ...
    parser.add_argument('--train_data_path', type=str, default='/DataSet/cnndailymail/finished_files/chunked/train_*', help='location of the train data path')
    parser.add_argument('--eval_data_path', type=str, default='/DataSet/cnndailymail/finished_files/val.bin', help='location of the eval data path')
