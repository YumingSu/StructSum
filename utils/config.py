...
train_data_path = os.path.join(root_dir, "/DataSet/cnndailymail/finished_files/chunked/train_*")
...
eval_data_path = os.path.join(root_dir, "/DataSet/cnndailymail/finished_files/val.bin")
decode_data_path = os.path.join(root_dir, "/DataSet/cnndailymail/finished_files/test.bin")
vocab_path = os.path.join(root_dir, "/DataSet/cnndailymail/finished_files/vocab")

embeddings_file = os.path.join(root_dir, '/DataSet/glove/glove.6B.300d.txt')
